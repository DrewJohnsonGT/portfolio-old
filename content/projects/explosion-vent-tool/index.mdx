...
<Paragraph>
    The tool performs all of the mathmatical calculations in real time,
    offloading some of the heavier calculations to the backend server and
    awaiting responses asynchronously.
</Paragraph>
